...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/29 04:20:13 by jelee             #+#    #+#             */
/*   Updated: 2020/10/06 12:34:52 by jelee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**
**	player is subtracted from sprite for dy
**
**  INSTEAD OF
**
** 	sprite is subtracted from player for dx
**
