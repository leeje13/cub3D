...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/30 21:40:25 by jelee             #+#    #+#             */
/*   Updated: 2020/10/07 21:35:16 by jelee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	As grid array x, y coordinates are stored inversed
...
void	c3d_player_next_position_wall_check(t_param *cub3d)
{
	...
	if (cub3d->next.x > 0 && cub3d->next.x < cub3d->map.width &&
		...
		!c3d_player_wall_collision(cub3d, cub3d->next.x, cub3d->next.y))
	{
		if (!c3d_player_wall_collision(cub3d,
...
{
	if (c3d_player_sprite_collision(cub3d, cub3d->player.x, cub3d->player.y))
	{
		cub3d->map.grid
